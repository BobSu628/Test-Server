...
/**
 * A client for the TicTacToe client.client_game, modified and extended from the
...
public class TicTacToeClient {
    ...
    /**
     * The client.client_game thread of the client will listen for messages
     ...
     * another client.client_game.  If the answer is no, the loop is exited and
